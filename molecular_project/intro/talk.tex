...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.52\textwidth}
      ...
      \item \texttt{molecular/data.shelf} training data
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \item XX minutes to present
      \item YY minutes for our questions
      \end{itemize}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{itemize}
      \item morning last day: we give you additional data
