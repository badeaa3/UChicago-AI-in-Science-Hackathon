...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{0.4\textwidth}
      \begin{figure}
        \includegraphics[width=0.5\textwidth]{qr_teams}
      \end{figure}
      \begin{exampleblock}{Organizing Team}
        \begin{itemize}
        \item Schmidt Postdoctoral Fellows \@ Uchicago
        \item AI + Science community
        \end{itemize}
      \end{exampleblock}
    \end{column}
  \end{columns}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \begin{exampleblock}{Slack Space for Communication}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=0.5\textwidth]{qr-slack}
        \end{figure}
      \end{exampleblock}
    \end{column}
    \begin{column}{0.5\textwidth}
      {\tiny\url{https://docs.google.com/spreadsheets/d/1QbVzLIgxW0LiaMQ5dpUCMQXtT_bGgAvIDExyWpC9UM4/edit?usp=sharing}}
      \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{qr_teams}
      \end{figure}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      \begin{exampleblock}{Deadline}
        Presentation and data must be submitted 9AM \@ May 9th
      \end{exampleblock}
    \end{column}
    \begin{column}{0.5\textwidth}
    \begin{figure}
